...
历史预览版本为 `v0.1.0-alpha.5`。2026-09-23 的 v0.1 开发代码已在 Windows x64、macOS x64 和 macOS arm64 上通过质量检查、真实 Electron 原生环境回归及安装包构建，见[验收记录](docs/project-plan.md#103-当前实现与验收2026-09-23)。本轮产物为未签名的开发包，尚未发布新的正式版本。
