...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        '-mx-(--panel-padding) -mb-(--panel-padding) flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/50 p-(--panel-padding) sm:flex-row sm:justify-end',
        className,
      )}
      {...props}
    >
