...
export const kernelInstallations = sqliteTable(
...
export const environmentRevisions = sqliteTable(
  ...
  (table) => ({
    identity: uniqueIndex('idx_environment_revisions_identity').on(
      table.environmentId,
      table.revision,
    ),
  }),
